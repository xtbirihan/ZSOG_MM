...
CLASS lcl_event_receiver IMPLEMENTATION.
  ...
  METHOD hotspot_click.
    ...
    IF sy-subrc EQ 0."C
      IF e_column_id = 'SAT_NO' .
*        CONCATENATE '00' gs_out-sat_no INTO lv_sat.
*            MODIFY gt_out FROM gs_out INDEX e_row_id TRANSPORTING sat_no.
        CHECK gs_out-sat_no IS NOT INITIAL.
        SET PARAMETER ID 'BAN' FIELD gs_out-sat_no.
  ...
  METHOD handle_double_click.
    ...
    READ TABLE gt_out INDEX e_row-index INTO gs_out TRANSPORTING message.
    ...
    CALL FUNCTION 'POPUP_WITH_TABLE_DISPLAY_OK'
      ...
      EXCEPTIONS
        ...
        OTHERS       = 2.
    IF sy-subrc <> 0.
      MESSAGE s123(zmm) WITH 'Detaylar görüntülenemiyor.' DISPLAY LIKE 'E'.
    ENDIF.
