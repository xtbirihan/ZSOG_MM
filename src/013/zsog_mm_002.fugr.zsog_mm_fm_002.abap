...
*"  EXPORTING
*"     VALUE(ET_PAYACC_INFO) TYPE  ZMM_TT_006
...
*"----------------------------------------------------------------------
  ...
  DATA : lv_error        TYPE c,
         lv_dummy        TYPE c.
  DATA : lr_file_date TYPE RANGE OF zsg_t_002-file_date
        WITH HEADER LINE,
         lr_cust_no TYPE RANGE OF char10 WITH
         HEADER LINE,
         lr_year TYPE RANGE OF zsg_t_002-gjahr
        WITH HEADER LINE,
         lr_month TYPE RANGE OF zsg_t_002-monat WITH
         HEADER LINE.
  DATA : lt_data TYPE TABLE OF zsg_t_002,
         ls_data TYPE zsg_t_002,
         ls_payacc_info TYPE zmm_s_006.
...
**  ENDIF.
  ...
  LOOP AT lt_data INTO ls_data.
    MOVE-CORRESPONDING ls_data TO ls_payacc_info.
    APPEND ls_payacc_info TO et_payacc_info.
    CLEAR : ls_payacc_info,ls_data.
  ENDLOOP.

  IF et_payacc_info IS INITIAL.
