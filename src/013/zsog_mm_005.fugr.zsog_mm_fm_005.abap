...
*"  EXPORTING
*"     VALUE(ET_SBS_SALES_INFO) TYPE  ZMM_TT_009
...
*"----------------------------------------------------------------------
  ...
  DATA : lv_error        TYPE c,
         lv_dummy        TYPE c.
  DATA : lr_file_date TYPE RANGE OF zsg_t_021-file_date
          WITH HEADER LINE,
           lr_cust_no TYPE RANGE OF char10 WITH
           HEADER LINE,
           lr_year TYPE RANGE OF zsg_t_021-gjahr
          WITH HEADER LINE,
           lr_month TYPE RANGE OF zsg_t_021-monat WITH
           HEADER LINE.
  DATA : lt_data TYPE TABLE OF zsg_t_021,
         ls_data TYPE zsg_t_021,
         ls_sbs_sales_info TYPE zmm_s_009.
  ...
  LOOP AT lt_data INTO ls_data.
    MOVE-CORRESPONDING ls_data TO ls_sbs_sales_info.
    APPEND ls_sbs_sales_info TO et_sbs_sales_info.
    CLEAR : ls_sbs_sales_info,ls_data.
  ENDLOOP.

  IF et_sbs_sales_info IS INITIAL.
