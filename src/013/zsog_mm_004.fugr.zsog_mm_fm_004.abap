...
*"  EXPORTING
*"     VALUE(ET_SALESACC_INFO) TYPE  ZMM_TT_004
...
*"----------------------------------------------------------------------
  ...
  DATA : lv_error        TYPE c,
         lv_dummy        TYPE c.
  DATA : lr_file_date TYPE RANGE OF zsg_t_001-file_date
          WITH HEADER LINE,
           lr_cust_no TYPE RANGE OF char10 WITH
           HEADER LINE,
           lr_year TYPE RANGE OF zsg_t_001-gjahr
          WITH HEADER LINE,
           lr_month TYPE RANGE OF zsg_t_001-monat WITH
           HEADER LINE.
  DATA : lt_data TYPE TABLE OF zsg_t_001,
         ls_data TYPE zsg_t_001,
         ls_salesacc_info TYPE zmm_s_004.
  ...
  LOOP AT lt_data INTO ls_data.
    MOVE-CORRESPONDING ls_data TO ls_salesacc_info.
    APPEND ls_salesacc_info TO et_salesacc_info.
    CLEAR : ls_salesacc_info,ls_data.
  ENDLOOP.

  IF et_salesacc_info IS INITIAL.
